        ...
        <div className="container">
          <div className="friendship-block">
            ...
            <div className="friendship-text">
              <h2>Short landing</h2>
              <p>
                My pet-project, which I made for experience and to show my
                ability to create a landing page. <br />
                <br />
                <br />
                <a
          ...
          <div className="friendship-block">
            ...
            <div className="friendship-text">
              <h2>Mini-game</h2>
              <p>
                Another project just a short mini game named in russian
                visilitsa
                <br />
                <br />
                <br />
          ...
          <div className="friendship-block">
            ...
            <div className="friendship-text">
              ...
              <p>
                This masterpiece was made for my birthday, and it is quite
                simple.
                <br />
                <br />
                <br />
          ...
          <div className="friendship-block">
            ...
            <div className="friendship-text">
              ...
              <p>
                Here you can planning your day, and obviously all website made
          ...
          <div className="friendship-block">
            ...
            <div className="friendship-text">
              ...
              <p>
                Boost your focus. Beat procrastination. Work smarter — not
                harder. Welcome to your ultimate Pomodoro Timer — designed to
                help you stay productive and refreshed all day. <br />
                ...
                your mind sharp and your goals in motion. Start your flow. Stay
                in control. Pomodoro your day.
                <br />
                <br />
                <br />
                <a
